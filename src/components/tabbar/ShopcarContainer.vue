<template>
    <div class="shopCarContainer">
        ...
        <!-- 测试： 1、各商品id对应的数量 2、选中商品总量和总价 -->
        <!-- <div>{{$store.getters.getGoodsCount}}</div> -->
        <!-- <div>{{$store.getters.getSelectedCountAndTotal}}</div> -->
         ...
         <div class="mui-card">
			<div class="mui-card-content">
				<div class="mui-card-content-inner jiesuan">
					<div class="left">
                        <p>总计(不含运费)</p>
                        <p>已勾选商品<span class="red">{{$store.getters.getSelectedCountAndTotal.count}}</span>件，总价 <span class="red">¥ {{$store.getters.getSelectedCountAndTotal.total}} </span></p>
                    </div>
